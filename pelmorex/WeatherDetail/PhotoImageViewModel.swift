...
final class PhotoImageViewModel {
    ...
    func getPhotos() {
        photos = [
            ...
            PhotoModel(photo: UIImage(named: "Calgary04")!, city: .Calgary),
            PhotoModel(photo: UIImage(named: "Calgary05")!, city: .Calgary),
            PhotoModel(photo: UIImage(named: "Calgary06")!, city: .Calgary),
